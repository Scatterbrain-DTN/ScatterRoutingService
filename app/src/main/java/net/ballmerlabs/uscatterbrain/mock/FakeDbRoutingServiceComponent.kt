...
@Singleton
@Component(modules = [FakeDbRoutingServiceComponent.RoutingServiceModule::class])
interface FakeDbRoutingServiceComponent {
    ...
    interface Builder {
        ...
        @BindsInstance
        fun datastore(datastore: Datastore): Builder?
        fun build(): FakeDbRoutingServiceComponent?
    }
    ...
    fun datastore(): ScatterbrainDatastore
