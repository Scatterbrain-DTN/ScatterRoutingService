...
interface ScatterbrainDatastore {
    ...
    /**
     * Gets the autogenerated file path (in the router's private directory) for a given
     * header packet. The returned path is content-dependent to avoid collisions
     * @param packet header packet
     * @return file object for autogenerated path
     */
