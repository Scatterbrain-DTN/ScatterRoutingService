...
interface ScatterbrainDatastore {
     ...
     */
    fun insertMessages(message: DbMessage): Completable
     ...
     * @return livedata representation of list of messages
     */
    fun getMessagesByIdentity(id: KeylessIdentity): Observable<DbMessage>
     ...
     */
    fun getMessageByPath(path: String): Single<DbMessage>
